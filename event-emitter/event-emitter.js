...
function creteFizzBussEventEmitter(until) {
  const eventEmitter = new events.EventEmitter()
  process.nextTick(() => _emitFizzBuss(eventEmitter, until))
  return eventEmitter
}

async function _emitFizzBuss(eventEmitter, until) {
